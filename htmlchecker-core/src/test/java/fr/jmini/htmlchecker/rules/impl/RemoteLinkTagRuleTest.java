...
public class RemoteLinkTagRuleTest extends AbstractRemoteRuleTest<RemoteLinkTagRule> {

  @Test
  public void testGetLintErrors() throws Exception {
    setupRule();
    File file = new File(Resources.getResource("remote-link.html").getPath());
...
//    }
  ...
  @Override
  protected RemoteLinkTagRule newRule() {
    return new RemoteLinkTagRule();
  }
}
